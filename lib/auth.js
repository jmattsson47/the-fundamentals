...
/* Read an env var, trimmed. Trailing/leading whitespace in a dashboard
   value (easy to paste by accident) silently breaks comparisons and the
   OAuth client_id, so always trim. */
